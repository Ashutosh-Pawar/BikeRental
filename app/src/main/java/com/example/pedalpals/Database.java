...
public class Database extends SQLiteOpenHelper {
    ...
    public Cursor getAllDataDate_Transaction(String date){
     /* SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
       ...
       */
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor result = db.rawQuery("SELECT * FROM "+TABLE_TRANSACTION+" WHERE start_date=?",new String[]{date});
        return result;
    }
