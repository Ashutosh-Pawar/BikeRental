...
public class ViewTransactionDateWiseReport extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_transaction_date_wise_report);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.nav_menu:
                Intent i = new Intent(ViewTransactionDateWiseReport.this, AdminMenu.class);
                startActivity(i);
                finish();
                break;

            case R.id.nav_profile:
                Intent i1 = new Intent(ViewTransactionDateWiseReport.this, AdminProfile.class);
                startActivity(i1);
                break;
    ...
    private void logout(){
        AlertDialog.Builder builder=new AlertDialog.Builder(ViewTransactionDateWiseReport.this);
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent i = new Intent(ViewTransactionDateWiseReport.this, MainActivity.class);
                startActivity(i);
